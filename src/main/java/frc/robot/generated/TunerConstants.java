...
public class TunerConstants {
    ...
    .withKV(2.49).withKA(0).withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    ...
    // Configs for the Pigeon 2; leave this null to skip applying Pigeon 2
    // configs
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.1484375);
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.469482421875);
    ...
    .createModuleConstants(kFrontLeftSteerMotorId, kFrontLeftDriveMotorId, kFrontLeftEncoderId, kFrontLeftEncoderOffset,
    ...
    .createModuleConstants(kBackRightSteerMotorId, kBackRightDriveMotorId, kBackRightEncoderId, kBackRightEncoderOffset,
